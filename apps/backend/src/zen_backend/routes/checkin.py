...
_QUESTIONS_BY_WINDOW: dict[str, list[dict[str, object]]] = {
    "morning": [
        ...
        {"key": "body_readiness", "label": "How does your body feel — light or stiff?", "scale": [1, 5]},
    ...
    "midday": [
        ...
        {"key": "social_drain", "label": "Has the morning drained you socially?", "scale": [1, 5]},
    ],
    "evening": [
        {"key": "day_satisfaction", "label": "How satisfied are you with how today went?", "scale": [1, 5]},
        {"key": "accomplishment", "label": "Did you do what mattered most today?", "scale": [1, 5]},
        {"key": "gratitude_moment", "label": "Did one real moment today actually feel good?", "scale": [1, 5]},
